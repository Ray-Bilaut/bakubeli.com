...
// form open
echo form_open(base_url('admin/user/update/'.$user->user_id), 'class="form-horizontal"');
?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control"  name="name" placeholder="Fullname" value="<?= $user->name ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="inputPassword3" name="password" placeholder="Password" value="<?= $user->password ?>" required>
                    </div>
                  </div>
