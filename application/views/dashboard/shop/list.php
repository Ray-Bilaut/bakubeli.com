<section class="cart bgwhite p-t-70 p-b-100">
	<div class="container">
		...
		?>
			...
			<img src="<?= base_url('assets/templates/images/kosong.png')  ?>" class="img img-responsive" width="200">
			<p>Wah! keranjangmu Kosong! Isi dulu yuk</p>
			  ...
			  <td  class="column-2"><a href="<?= base_url('customer/product/detail/'.$prod->slug_product) ?>"><?= $shop['name']?></a></td>
			    ...
			    <td class="column-4">
								<div class="flex-w bo5 of-hidden w-size17">
									...
									<input class="size8 m-text18 t-center num-product" id="quantity" type="number" name="qty" value="<?= $shop['qty'] ?>">
...
<td class="column-4" colspan="2"><strong>Rp.<?= number_format($this->cart->total(),'0',',','.')   ?></strong>
	...
	<div class="mr-2">
		<a href="<?=base_url('customer/shop/delete') ?>" class="btn btn-md btn-dark">Bersihkan</a>
	</div>
	<div>
		<a href="<?= base_url('customer/shop/checkout') ?>" class="btn btn-md btn-dark">Bayar</a>
	</div>
	</div>
