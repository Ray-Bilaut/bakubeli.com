	...
	<footer class="bg6 p-t-45 p-b-43 p-l-45 p-r-45">
		<div class="flex-w p-b-90">
			<div class="w-size6 p-t-30 p-l-15 p-r-15 respon3">
				...
				<div>
					...
					<div class="flex-m p-t-30">
						...
						<a href="<?=$site->instagram ?>" class="fs-18 color1 p-r-20 fa fa-twitter"></a>
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="<?= base_url('customer/product/category/'.$np->slug_category) ?>" class="s-text7">
							<?= $np->category_name ?><br>
						</a>
					</li>
					<?php } ?>
		...
		<div class="t-center p-l-15 p-r-15">
			<div class="t-center s-text8 p-t-20">
				Hak Cipta © 2019 - <?= date('Y') ?> Anugerah Timor tech | <img src="<?= base_url('assets/upload/image/'.$site->logo); ?>" class="img img-responsive" width="100" ALT="logo-bakubeli">
			</div>
		</div>
	</footer>
	...
	<script type="text/javascript">
		$('.block2-btn-addcart').each(function(){
			...
			$(this).on('click', function(){
				swal(nameProduct, "Ditambahkan keranjang !", "success");
			});
		});
		...
		$('.block2-btn-addwishlist').each(function(){
			var nameProduct = $(this).parent().parent().parent().find('.block2-name').html();
			$(this).on('click', function(){
				swal(nameProduct, "Ditambahkan ke favorit !", "success");
			});
		});
	</script>
