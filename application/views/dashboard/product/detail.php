...
<a href="<?= base_url('customer/home') ?>" class="s-text16">
	Home
	<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
</a>

<a href="<?= base_url('customer/product') ?>" class="s-text16">
	Produk
	<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i> 
		...
		<div class="p-t-33 p-b-60">
			...
			<div class="flex-r-m flex-w p-t-10">
				<div class="w-size16 flex-m flex-w">
					...
					<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
						<!-- Button -->
						<a href="<?= base_url('customer/shop/checkout') ?>" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
							Beli
						</a>
					</div>
				</div>
...
<a href="<?= base_url('customer/product/detail/'.$prel->slug_product) ?>" class="block2-name dis-block s-text3 p-b-5">
<?=$prel->product_name ?>
</a>
