		...
		<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
			<div class="leftbar p-r-20 p-r-0-sm">
				...
				<ul class="p-b-54">
					...
					<li class="p-t-4">
						<a href="<?= base_url('product/category/'.$lc->slug_category) ?>" class="s-text13 active1">
							<?= $lc->category_name ?>
						</a>
					</li>
				<?php } ?>
...
?>
					...
					<div class="block2">
						...
						<div class="block2-txt p-t-20">
							<a href="<?= base_url('product/detail/'.$product->slug_product) ?>" class="block2-name dis-block s-text3 p-b-5">
