...
// LOAD MODEL
	...
	public function index()
	{
		...
		$config['base_url'] 		= base_url().'/customer/product/index';
		...
		$config['first_url']		= base_url().'/customer/product/';
	...
	public function category($slug_category)
	{
		...
		$config['base_url'] 		= base_url().'/customer/product/category/'.$slug_category.'/index/';
		$config['total_rows'] 		= $total->total;
		$config['use_page_number']	= TRUE;
		$config['per_page'] 		= 12;
		...
		$config['cur_tag_close'] 	= '</a></li>';
		$config['attributes']		= array('class' => 'page-link bg-light');
		$config['first_url']		= base_url().'/customer/product/category/'.$slug_category;
		$this->pagination->initialize($config);
