...
//jika ada data row id
	if ($rowid) {
		...
		redirect(base_url('customer/shop'),'refresh');
	}else{
//jika tidak ada data row id
		redirect(base_url('dashboard/shop'),'refresh');
...
public function checkout()
{
	...
	//Input database
          ...
          $this->session->set_flashdata('pesan', '<small class="alert alert-success" role="alert"> Yeay!! Checkout berhasil!</small>');
            redirect(base_url('customer/shop/success'),'refresh');
        }
        //End input database
